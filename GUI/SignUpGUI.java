...
public class SignUpGUI extends JFrameBaseForGUI {
	...
	public SignUpGUI() {
		...
		lblNewLabel.setFont(Font_Tahoma_Bold_Size12);
		...
		lblUsername.setFont(Font_Tahoma_Bold_Size12);
		...
		lblPassword.setFont(Font_Tahoma_Bold_Size12);
		...
		lblDepartment.setFont(Font_Tahoma_Bold_Size12);
		...
		lblYear.setFont(Font_Tahoma_Bold_Size12);
		lblYear.setBounds(192, 362, 112, 24);
		lblYear.setVisible(false);
		contentPane.add(lblYear);
		
		JButton btnSignUp = new JButton("Sign Up");
		btnSignUp.setFont(Font_Tahoma_Plain_Size13);
		...
		lblDesignation.setFont(Font_Tahoma_Bold_Size12);
		...
		lblLastName.setFont(Font_Tahoma_Bold_Size12);
		...
		goback.setFont(Font_TimesNewRoman_Plain_Size14);
